...
5 Quick Links
 ...
 /\* RSID: \*/ var s\_account="awdappledeveloper" s.pageName= AC && AC.Tracking && AC.Tracking.pageName(); s.channel="www.en.developer" s.channel="www.appstore.developer"; /\*\*\*\*\*\*\*\*\*\*\*\*\* DO NOT ALTER ANYTHING BELOW THIS LINE ! \*\*\*\*\*\*\*\*\*\*\*\*\*\*/ var s\_code=s.t();if(s\_code)document.write(s\_code)  
...
Guidelines that include ![ASR & NR](/app-store/review/images/key-icon.svg) apply to [Notarization for iOS and iPadOS apps](/support/dma-and-apps-in-the-eu/#notarization-for-ios-apps) in the EU.
